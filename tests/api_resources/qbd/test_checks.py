...
class TestChecks:
    ...
    def test_method_void(self, client: Conductor) -> None:
        check = client.qbd.checks.void(
            id="123ABC-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
        assert_matches_type(CheckVoidResponse, check, path=["response"])

    @parametrize
    def test_raw_response_void(self, client: Conductor) -> None:
        response = client.qbd.checks.with_raw_response.void(
            id="123ABC-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    def test_streaming_response_void(self, client: Conductor) -> None:
        with client.qbd.checks.with_streaming_response.void(
            id="123ABC-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_void(self, client: Conductor) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.qbd.checks.with_raw_response.void(
                id="",
                conductor_end_user_id="end_usr_1234567abcdefg",
            )
...
class TestAsyncChecks:
    ...
    async def test_method_void(self, async_client: AsyncConductor) -> None:
        check = await async_client.qbd.checks.void(
            id="123ABC-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
        assert_matches_type(CheckVoidResponse, check, path=["response"])
    ...
    async def test_raw_response_void(self, async_client: AsyncConductor) -> None:
        response = await async_client.qbd.checks.with_raw_response.void(
            id="123ABC-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    async def test_streaming_response_void(self, async_client: AsyncConductor) -> None:
        async with async_client.qbd.checks.with_streaming_response.void(
            id="123ABC-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_void(self, async_client: AsyncConductor) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.qbd.checks.with_raw_response.void(
                id="",
                conductor_end_user_id="end_usr_1234567abcdefg",
            )
