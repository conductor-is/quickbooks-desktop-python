...
class TestConductor:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Conductor) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Conductor) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
...
class TestAsyncConductor:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncConductor) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
