...
class EmployeesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        adjusted_service_date: str | NotGiven = NOT_GIVEN,
        ...
        hired_date: str | NotGiven = NOT_GIVEN,
        ...
        original_hire_date: str | NotGiven = NOT_GIVEN,
        ...
        termination_date: str | NotGiven = NOT_GIVEN,
        ...
        work_authorization_expiration_date: str | NotGiven = NOT_GIVEN,
