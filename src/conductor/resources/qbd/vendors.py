    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          updated_after: Filter for vendors updated on or after this date/time. Format: ISO 8601. Accepts
          ...
          updated_before: Filter for vendors updated on or before this date/time. Format: ISO 8601.
