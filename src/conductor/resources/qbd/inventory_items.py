    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          updated_after: Filter for inventory items updated on or after this date/time. Format: ISO 8601.
          ...
          updated_before:
              Filter for inventory items updated on or before this date/time. Format:
