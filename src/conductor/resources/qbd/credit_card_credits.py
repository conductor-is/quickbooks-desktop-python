...
from ...types.qbd.credit_card_credit_void_response import CreditCardCreditVoidResponse
...
class CreditCardCreditsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        **IMPORTANT:** If you need to fetch multiple specific credit card credits by ID,
        ...
        extra_headers = {"Conductor-End-User-Id": conductor_end_user_id, **(extra_headers or {})}
        return self._get(
            path_template("/quickbooks-desktop/credit-card-credits/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CreditCardCredit,
    ...
    def void(
        ...
        *,
        ...
        """
        Voids a credit card credit by setting its amount to zero while preserving its
        record in QuickBooks. The void will fail if the credit card credit is currently
        in use or has any linked transactions that are in use.

        Args:
          id: The QuickBooks-assigned unique identifier of the credit card credit to void.
        ...
        extra_headers = {"Conductor-End-User-Id": conductor_end_user_id, **(extra_headers or {})}
        return self._post(
            path_template("/quickbooks-desktop/credit-card-credits/{id}/void", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CreditCardCreditVoidResponse,
        )
