...
class CompanyResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        Note that company information can only be read through the API, not added or
        modified. Changes to company information can only be made directly through the
        QuickBooks Desktop user interface.
