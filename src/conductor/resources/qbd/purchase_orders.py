    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          updated_after: Filter for purchase orders updated on or after this date/time. Format: ISO 8601.
          ...
          updated_before:
              Filter for purchase orders updated on or before this date/time. Format:
