...
__all__ = ["SalesTaxGroupItemListParams"]


class SalesTaxGroupItemListParams(TypedDict, total=False):
    ...
    """
    Filter for specific sales-tax group items by their QuickBooks-assigned unique
    identifier(s).
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for sales-tax group items whose `name` contains this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameStartsWith` or
    ...
    """
    Filter for sales-tax group items whose `name` ends with this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameContains` or
    ...
    """
    Filter for sales-tax group items whose `name` is alphabetically greater than or
    equal to this value.
    """

    names: SequenceNotStr[str]
    """Filter for specific sales-tax group items by their name(s), case-insensitive.
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for sales-tax group items whose `name` starts with this substring,
    case-insensitive.
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameContains` or
    ...
    """
    Filter for sales-tax group items whose `name` is alphabetically less than or
    equal to this value.
    """
    ...
    """Filter for sales-tax group items updated on or before this date/time.
