...
__all__ = ["ReportPayrollSummaryParams"]


class ReportPayrollSummaryParams(TypedDict, total=False):
    report_type: Required[
        Annotated[
            Literal["employee_earnings_summary", "payroll_liability_balances", "payroll_summary"],
