...
__all__ = ["SalesTaxPaymentCheckListParams"]


class SalesTaxPaymentCheckListParams(TypedDict, total=False):
    ...
    """
    Filter for specific sales-tax payment checks by their QuickBooks-assigned unique
    identifier(s).
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for sales-tax payment checks whose `refNumber` is greater than or equal
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for sales-tax payment checks whose `refNumber` starts with this
    substring.
    ...
    **NOTE**: If you use this parameter, you cannot also use `refNumberContains` or
    ...
    """
    Filter for sales-tax payment checks whose `refNumber` is less than or equal to
    ...
    """
    Filter for sales-tax payment checks whose `date` field is on or after this date,
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **start of the
    ...
    """
    Filter for sales-tax payment checks whose `date` field is on or before this
    ...
    **NOTE:** QuickBooks Desktop interprets this date as the **end of the specified
    ...
    """Filter for sales-tax payment checks updated on or after this date/time.
    ...
    """Filter for sales-tax payment checks updated on or before this date/time.
    ...
    """Filter for sales-tax payment checks paid to these vendors.

    These are the sales-tax agencies, represented as QuickBooks vendors, paid by
    these checks.
    """
